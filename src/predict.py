...
from .config import DATA_DIR, MODEL_DIR, INPUT_SHAPE
...
if __name__ == '__main__':
    ...
    image_path = 'data/Meta/20.png'
    print(f'Predicted sign: {recognizer.predict(image_path)}')

# cần tạo 1 api để user gửi ảnh lên và nhận lại kết quả dự đoán: Predicted sign: Dangerous curve to the right